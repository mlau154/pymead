...
class SymmetricBaseAirfoilParams:
    ...
    def __init__(self,
        ...
        The reduced parameter set used in a `pymead.symmetric.symmetric_airfoil.SymmetricAirfoil`.
        """
        self.c = c
        self.alf = alf
        self.R_le = R_le
    ...
    def scale_vars(self):
        ...
        Scales all of the `pymead.core.param.Param`s in the `SymmetricBaseAirfoilParams` with `units == 'length'`
        by the `length_scale_dimension`. Scaling only occurs for each parameter if the `pymead.core.param.Param` has
        not yet been scaled.
        """
    ...
    def count_overrideable_variables(self):
        ...
        Counts all the overrideable `pymead.core.param.Param`s in the `SymmetricBaseAirfoilParams` (criteria:
    ...
    def override(self, parameters: list):
        ...
        Overrides all the `pymead.core.param.Param`s in `SymmetricBaseAirfoilParams` which are active and not
