...
a = Analysis(
    ...
    datas=[
        ...
        ('../tests/gui_tests/iso_prop/*', 'pymead/tests/gui_tests/iso_prop/'),
        ('../tests/gui_tests/iso_prop_test_0/*', 'pymead/tests/gui_tests/iso_prop_test_0/'),
        ('../tests/gui_tests/analysis_temp_iso_prop/ga_airfoil_3/*', 'pymead/tests/gui_tests/analysis_temp_iso_prop/ga_airfoil_3/'),
    ],
    hiddenimports=[],
    hookspath=[],
    runtime_hooks=[],
