...
def main():
    anchor_point = AnchorPoint(Param(0.0), Param(0.0), 'upper_surf_ap', 'te_1', Param(0.1), Param(0.08), Param(0.6),
                               Param(np.deg2rad(10)), Param(np.deg2rad(120)), Param(np.deg2rad(100)))
