...
class GCSTests(TestCase):
    ...
    def test_complex_case_1(self):
        geo_col = GeometryCollection()
        p1 = geo_col.add_point(0.0, 0.0)
        p2 = geo_col.add_point(1.0, 0.0)
        d1 = DistanceConstraint(p1=p1, p2=p2, value=1.0)
        geo_col.add_constraint(d1)
        p3 = geo_col.add_point(0.3, 0.1)
        p4 = geo_col.add_point(0.6, 0.05)
        d2 = DistanceConstraint(p1, p3, value=0.25)
        d3 = DistanceConstraint(p3, p4, value=0.25)
        geo_col.add_constraint(d2)
        geo_col.add_constraint(d3)
        ap1 = AntiParallel3Constraint(p1, p3, p4)
        ap2 = AntiParallel3Constraint(p3, p4, p2)
        geo_col.add_constraint(ap1)
        geo_col.add_constraint(ap2)
        p5 = geo_col.add_point(0.0, 0.1)
        p6 = geo_col.add_point(0.0, -0.1)
        d4 = DistanceConstraint(p1, p5, value=0.1)
        d5 = DistanceConstraint(p1, p6, value=0.1)
        geo_col.add_constraint(d4)
        geo_col.add_constraint(d5)
        ap3 = AntiParallel3Constraint(p6, p1, p5)
        geo_col.add_constraint(ap3)
